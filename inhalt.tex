...
\institute[\raisebox{-1ex}{\includegraphics[height=0.24cm]{images/JW_Kontur}}]{\includegraphics[scale=0.3]{images/J_60_Schwarz_Reflex_Blue}}
\title{QM-Cockpit}
...
\begin{frame}{\alt<1>{70 Stunden Projektzeit}{80\,\% Zeitersparnis}}
